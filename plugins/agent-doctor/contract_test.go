...
func TestPluginContract(t *testing.T) {
	...
	for _, required := range []string{"name: agent-doctor", "get_project_analysis", "before the final answer", "diagnose_last_task", "Never guess", "read-only", "current project ID", "every coding turn", "Agent Doctor intervened"} {
