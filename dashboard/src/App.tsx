...
const emptyAnalysis: LiveAnalysis = { requests: 0, activeSessions: 0, inputTokens: 0, outputTokens: 0, cachedTokens: 0, reasoningTokens: 0, exactCostMicros: 0, estimatedCostMicros: 0, unknownCostCount: 0, averageLatencyMs: 0, limitations: [] };
